...
const AttendanceEmployee = () => {
  ...
  var hour = parseInt(timeString.split(" ")[4].split(":")[0]);

  // Define a function to get the appropriate greeting based on the time of day
  ...
  // Get the appropriate greeting for the current time
        ...
        <div className="content">
          <div className="attendance-header">
            <div className="attendance-content">
              ...
              />
              <h3>
                {greeting}, <span>Shrey Kuvera</span>
              </h3>
            </div>
            <div>
              ...
              <div className="col-xl-4 col-lg-12 col-md-4 d-flex">
                <div className="card w-100">
                  <div className="card-body">
                    <h5>
                      Attendance<span>{currentDate.toString()}</span>
                    </h5>
