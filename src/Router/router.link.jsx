...
import MaterialDispatch from "../feature-module/MaterialDispatch";
import { element } from "prop-types";
import TAmtvsAch from "../feature-module/TargetAMTvsAchivement";
import TableTes from "../feature-module/TargetAMTvsAchivement/tableTes";
import QTargetVsAchivement from "../feature-module/qtyTargetvsAchivement";
import LedgerReport from "../feature-module/ledger";
import QtyMonthlyReport from "../feature-module/QtyMonthlyReport";
import ItemWiseMonthly from "../feature-module/itemWiseMonthly";
import POAndPendingPODetail from "../feature-module/Supplier/POAndPendingPODetail";
import AgingReceivable from "../feature-module/AgingReceivable";
import PurchaseDashboard from "../feature-module/dashboard/purchase";
import SchemDetails from "../feature-module/SchemeDetails";
export const publicRoutes = [
  ...
  // {
  //   id: 120,
  //   path: routes.materialDispatch,
  //   name: "materialDispatch",
  //   element: <MaterialDispatch />,
  //   route: Route,
  // },
  {
    id: 121,
    path: routes.targetAmountvsAchivement,
    name: "targetAmountvsAchivement",
    element: <TAmtvsAch />,
    route: Route,
  },
  // {
  //   id: 122,
  //   path: routes.TableTes,
  //   name: "TableTes",
  //   element: <TableTes />,
  //   route: Route,
  // },
  {
    id: 123,
    path: routes.QTargetVsAchivement,
    name: QTargetVsAchivement,
    element: <QTargetVsAchivement />,
    route: Route,
  },
  {
    id: 124,
  ...
  {
    id: 125,
    path: routes.QtyMonthlyReport,
    name: QtyMonthlyReport,
    element: <QtyMonthlyReport />,
    route: Route,
  },
  {
    id: 125,
  ...
  {
    id: 126,
    path: routes.ItemWiseMonthly,
    name: ItemWiseMonthly,
    element: <ItemWiseMonthly />,
    route: Route,
  },
  {
    id: 127,
    path: routes.POAndPendingPODetail,
    name: POAndPendingPODetail,
    element: <POAndPendingPODetail />,
    route: Route,
  },
  {
    id: 129,
    path: routes.AgingReceivable,
    name: AgingReceivable,
    element: <AgingReceivable />,
    route: Route,
  },
  {
    id: 130,
  ...
  {
    id: 130,
    path: routes.SchemDetails,
    name: "SchemDetails",
    element: <SchemDetails />,
    route: Route,
  },
];
